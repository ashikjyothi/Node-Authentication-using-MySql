...
module.exports = class sql {
    ...
    SignUp(usn, psw, callback) {
        ...
        mySql.query('insert into Users(FName,LName,UserName,psw,Email_id,Mob_no,Address) values("Test","lst",?,?,"sms@gmail.com","987654321","Vat Mang")', [usn, psw], function(err, rows) {
            if (err) throw err;
            callback(rows);
        });
